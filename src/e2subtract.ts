...
exports.id = 'e2subtract';
exports.title = 'Subtract';
exports.group = 'Math';
exports.color = '#08a351';
exports.version = '1.0.0';
exports.author = 'William Clark';
exports.icon = 'minus-circle';  // Icon reference from https://fontawesome.com/v4.7.0/icons/
exports.input = true;
exports.output = 1;
exports.options = { enabled: true };
exports.readme = `# Subtract Numbers

Subtract numeric values recieved from each other, and outputs total.`;
